...
$.fn.editableform.buttons = '<button type="submit" class="button small editable-submit">Mentés</button>'+
    '<button type="button" class="button small editable-cancel">Elvetés</button>';